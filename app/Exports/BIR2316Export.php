...
class BIR2316Export
{
    ...
    public function export(){
        try {
            $spreadsheet = IOFactory::load(storage_path('app/templates/bir_2316.xlsx'));
            $sheet = $spreadsheet->getSheetByName(worksheetName: 'BIR2316');
            ...
            $filename = $this->filters['user']->name . "_BIR2316.xlsx";
