        ...
        switch ($sheetName) {
            ...
            case 'C4':
                ...
                if($this->pds['pds_gov_id']){
                    ...
                    $sheet->setCellValue("D64", $this->pds['pds_gov_id']->date_of_issuance ? Carbon::parse($this->pds['pds_gov_id']->date_of_issuance)->format('m/d/Y') : '');
                }
