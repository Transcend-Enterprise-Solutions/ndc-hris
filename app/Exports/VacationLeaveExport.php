...
class VacationLeaveExport implements FromQuery, WithHeadings, WithMapping, WithStyles, ShouldAutoSize
{
    protected $statusesForVL;

    public function __construct($statusesForVL)
    {
        $this->statusesForVL = $statusesForVL;
    }

    public function query()
    {
        return LeaveApplication::query()
            ->where('type_of_leave', 'LIKE', '%Vacation Leave%')
            ->whereIn('status', $this->statusesForVL);
    }
