...
class CosSkRecordedPayroll extends Component
{
    public $pageSize = 30; 
    ...
    {
        $releasedPayrolls = CosSkPayslip::select('start_date', 'end_date')
        ...
        return view('livewire.admin.payroll-component.cos-sk-recorded-payroll',[
    ...
    public function deletePayroll(){
        try{
            $payslips = CosSkPayslip::where('start_date', Carbon::parse($this->start_Date))
