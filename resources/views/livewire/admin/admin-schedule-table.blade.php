<div x-data="{
    ...
    <div class="w-full bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-md">
        ...
        <div class="flex justify-between items-center mb-4">
            <button wire:click="openModal"
                class="px-4 py-2 bg-green-500 text-gray-100 rounded-md hover:bg-green-600 focus:outline-none dark:text-white">
                Add Schedule
            </button>
        </div>
        ...
        <div @click.away="isModalOpen = false" x-show="isModalOpen"
            ...
            <form wire:submit.prevent="saveSchedule" class="space-y-4">
                ...
                <div>
                    ...
                    <select id="emp_code" wire:model="emp_code" readonly
                        class="w-full p-2 border rounded text-gray-700 dark:text-gray-300 dark:bg-gray-700">
                        <option value="{{ $emp_code }}" selected>{{ $thisEmployeeName }}</option>
                    </select>
                ...
                <div class="flex space-x-4">
                    <div class="w-1/2">
                        <label for="default_start_time"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Default Start
                            Time</label>
                    ...
                    <div class="w-1/2">
                        <label for="default_end_time"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Default End Time</label>
                ...
                <div class="mt-4 flex justify-end">
                    <button type="submit"
                        class="px-4 py-2 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 dark:text-gray-300">
                        <span
                            class="bg-blue-500 hover:bg-blue-600 dark:bg-gray-700 dark:hover:bg-blue-600 px-4 py-2 rounded-md">
    ...
    <div x-show="confirmingScheduleDeletion"
        class="fixed inset-0 z-50 overflow-y-auto bg-black bg-opacity-40 flex items-center justify-center">
        <div @click.away="confirmingScheduleDeletion = false" x-show="confirmingScheduleDeletion"
            ...
            <div class="mt-4 flex justify-end space-x-2">
                <button wire:click="deleteConfirmed"
                    class="px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:bg-gray-700 dark:hover:bg-red-600 dark:text-gray-300 dark:hover:text-white">Delete</button>
                <button wire:click="closeConfirmationModal"
                    class="px-4 py-2 bg-gray-300 text-gray-800 rounded-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2 dark:bg-gray-600 dark:text-gray-300 dark:hover:bg-gray-400 dark:hover:text-white">Cancel</button>
            </div>
        </div>
    </div>
</div>