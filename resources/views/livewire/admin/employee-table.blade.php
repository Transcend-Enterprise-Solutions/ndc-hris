            ...
            <div class="flex justify-center w-full">
                <div class="overflow-x-auto w-full sm:w-4/5 bg-white rounded-2xl p-3 shadow dark:bg-gray-800">
                    ...
                    <div class="overflow-hidden text-sm pb-3">
                        ...
                        {{-- Employee's Data --}}
                        <div class="bg-gray-400 dark:bg-slate-300 p-2 text-gray-50 dark:text-slate-900 font-bold rounded-t-lg">I. PERSONAL INFORMATION</div>
                        <div>
            ...
            <div class="flex justify-center w-full">
                <div class="w-full bg-white rounded-2xl p3 sm:p-8 shadow dark:bg-gray-800 overflow-x-visible">
                    <div class="pb-4 pt-4 sm:pt-1">
                        <h1 class="text-3xl font-bold text-center text-slate-800 dark:text-white">EMPLOYEES LIST</h1>
                    </div>
                                       ...
                                       <!-- Provinces Dropdown -->
                                        ...
                                        <div class="relative inline-block text-left w-full">
                                            <button wire:click="toggleDropdownCity"
                                                ...
                                                text-sm font-medium tracking-wide text-neutral-800 dark:text-neutral-200 
                                                transition-colors duration-200 rounded-lg border border-gray-400
                                                hover:bg-gray-200 focus:outline-none dark:hover:bg-slate-600"                                                type="button">
                                                Filter by City
                                                <i class="bi bi-chevron-down w-5 h-5 ml-2 float-right"></i>
                                            </button>
                                        ...
                                        <div class="relative inline-block text-left w-full">
                                            ...
                                            @if($dropdownForCivilStatusOpen)
                                                <div class="absolute z-20 w-full p-3 bg-gray-50 rounded-lg border border-gray-400
                                                    shadow-md dark:bg-gray-700 max-h-60 overflow-y-auto scrollbar-thin1">
                    ...
                    <div class="flex flex-col p-3">
                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="inline-block w-full py-2 align-middle">
                                <div class="overflow-hidden border rounded-lg border-gray-400 dark:border-gray-300">
                                    <div class="overflow-x-auto">
                                        <table
                                            class="divide-y divide-gray-200 dark:divide-gray-300 w-full min-w-full">
                                            <thead
                                    ...
                                    <div class="p-5 border-t border-gray-200 dark:border-slate-600 text-neutral-500 dark:text-neutral-200 bg-gray-400 dark:bg-slate-300">
                                        {{ $users->links() }}
                                    </div>
