                        ...
                        <div class="m-scrollable">
                            ...
                            <div class="flex flex-col w-full border-2 border-gray-200 dark:border-slate-600 bg-gray-100 dark:bg-slate-700">
                                ...
                                <div class="w-full block sm:flex">
                                    ...
                                    <div class="w-full sm:w-2/6 flex flex-col justify-center p-2 items-start px-4 bg-white dark:bg-slate-700 relative">
                                        <div class="flex items-center">
                                            <input id="yes" type="radio" value="1" wire:model='q34aAnswer' name="answer34a" style="pointer-events: none">
                                            <label for="yes" class="ml-2">Yes</label>
                                            <input id="yes"  class="ml-10" value="0" type="radio" wire:model='q34aAnswer' name="answer34a" style="pointer-events: none">
                                ...
                                <div class="w-full block sm:flex">
                                    ...
                                    <div class="w-full sm:w-2/6 flex flex-col justify-end p-2 items-start px-4 bg-white dark:bg-slate-700 relative">
                                        <div class="flex items-center">
                                            <input id="yes" type="radio" value="1" wire:model.live='q34bAnswer' name="answer34b" style="pointer-events: none">
                                            <label for="yes" class="ml-2">Yes</label>
                                            <input id="yes"  class="ml-10" value="0" type="radio" wire:model.live='q34bAnswer' name="answer34b" style="pointer-events: none">
                                            <label for="yes" class="ml-2">No</label>
                                        </div>
                            ...
                            <div class="flex flex-col w-full border-2 border-gray-200 dark:border-slate-600 bg-gray-100 dark:bg-slate-700">
                                <div class="w-full block sm:flex">
                                    ...
                                    <div class="w-full sm:w-2/6 flex flex-col justify-end p-2 items-start px-4 bg-white dark:bg-slate-700 relative">
                                        <div class="flex items-center">
                                            <input id="yes" type="radio" value="1" wire:model.live='q35aAnswer' name="answer35a" style="pointer-events: none">
                                            <label for="yes" class="ml-2">Yes</label>
                                            <input id="yes"  class="ml-10" value="0" type="radio" wire:model.live='q35aAnswer' name="answer35a" style="pointer-events: none">
                                            <label for="yes" class="ml-2">No</label>
                                        </div>
                                        <div class="w-full block items-center text-gray-800 dark:text-gray-100 text-xs mt-2">
                                            <p class="text-gray-400">If YES, give details:</p>
                                ...
                                <div class="w-full block sm:flex">
                                    ...
                                    <div class="w-full sm:w-2/6 flex flex-col justify-end p-2 items-start px-4 bg-white dark:bg-slate-700 relative">
                                        <div class="flex items-center">
                                            <input id="yes" type="radio" value="1" wire:model.live='q35bAnswer' name="answer35b" style="pointer-events: none">
                                            <label for="yes" class="ml-2">Yes</label>
                                            <input id="yes"  class="ml-10" value="0" type="radio" wire:model.live='q35bAnswer' name="answer35b" style="pointer-events: none">
                                            <label for="yes" class="ml-2">No</label>
                                        </div>
                                        <div class="w-full block items-center text-gray-800 dark:text-gray-100 text-xs mt-2">
                                            <p class="text-gray-400">If YES, give details:</p>
                            ...
                            <div class="flex flex-col w-full border-2 border-gray-200 dark:border-slate-600 bg-gray-100 dark:bg-slate-700">
                                <div class="w-full block sm:flex">
                                    ...
                                    <div class="w-full sm:w-2/6 flex flex-col justify-end p-2 items-start px-4 bg-white dark:bg-slate-700 relative">
                                        <div class="flex items-center">
                                            <input id="yes" type="radio" value="1" wire:model.live='q36aAnswer' name="answer36a" style="pointer-events: none">
                                            <label for="yes" class="ml-2">Yes</label>
                                            <input id="yes"  class="ml-10" value="0" type="radio" wire:model.live='q36aAnswer' name="answer36a" style="pointer-events: none">
                                            <label for="yes" class="ml-2">No</label>
                                        </div>
                                        <div class="w-full block items-center text-gray-800 dark:text-gray-100 text-xs mt-2">
                                            <p class="text-gray-400">If YES, give details:</p>
                            ...
                            <div class="flex flex-col w-full border-2 border-gray-200 dark:border-slate-600 bg-gray-100 dark:bg-slate-700">
                                <div class="w-full block sm:flex">
                                    ...
                                    <div class="w-full sm:w-2/6 flex flex-col justify-end p-2 items-start px-4 bg-white dark:bg-slate-700 relative">
                                        <div class="flex items-center">
                                            <input id="yes" type="radio" value="1" wire:model.live='q37aAnswer' name="answer37a" style="pointer-events: none">
                                            <label for="yes" class="ml-2">Yes</label>
                                            <input id="yes"  class="ml-10" value="0" type="radio" wire:model.live='q37aAnswer' name="answer37a" style="pointer-events: none">
                                            <label for="yes" class="ml-2">No</label>
                                        </div>
                                        <div class="w-full block items-center text-gray-800 dark:text-gray-100 text-xs mt-2">
                                            <p class="text-gray-400">If YES, give details:</p>
                            ...
                            <div class="flex flex-col w-full border-2 border-gray-200 dark:border-slate-600 bg-gray-100 dark:bg-slate-700">
                                <div class="w-full block sm:flex">
                                    ...
                                    <div class="w-full sm:w-2/6 flex flex-col justify-end p-2 items-start px-4 bg-white dark:bg-slate-700 relative">
                                        <div class="flex items-center">
                                            <input id="yes" type="radio" value="1" wire:model.live='q38aAnswer' name="answer38a" style="pointer-events: none">
                                            <label for="yes" class="ml-2">Yes</label>
                                            <input id="yes"  class="ml-10" value="0" type="radio" wire:model.live='q38aAnswer' name="answer38a" style="pointer-events: none">
                                            <label for="yes" class="ml-2">No</label>
                                        </div>
                                        <div class="w-full block items-center text-gray-800 dark:text-gray-100 text-xs mt-2">
                                            <p class="text-gray-400">If YES, give details:</p>
                                ...
                                <div class="w-full block sm:flex">
                                    ...
                                    <div class="w-full sm:w-2/6 flex flex-col justify-end p-2 items-start px-4 bg-white dark:bg-slate-700 relative">
                                        <div class="flex items-center">
                                            <input id="yes" type="radio" value="1" wire:model.live='q38bAnswer' name="answer38b" style="pointer-events: none">
                                            <label for="yes" class="ml-2">Yes</label>
                                            <input id="yes"  class="ml-10" value="0" type="radio" wire:model.live='q38bAnswer' name="answer38b" style="pointer-events: none">
                                            <label for="yes" class="ml-2">No</label>
                                        </div>
                                        <div class="w-full block items-center text-gray-800 dark:text-gray-100 text-xs mt-2">
                                            <p class="text-gray-400">If YES, give details:</p>
                            ...
                            <div class="flex flex-col w-full border-2 border-gray-200 dark:border-slate-600 bg-gray-100 dark:bg-slate-700">
                                <div class="w-full block sm:flex">
                                    ...
                                    <div class="w-full sm:w-2/6 flex flex-col justify-end p-2 items-start px-4 bg-white dark:bg-slate-700 relative">
                                        <div class="flex items-center">
                                            <input id="yes" type="radio" value="1" wire:model.live='q39aAnswer' name="answer39a" style="pointer-events: none">
                                            <label for="yes" class="ml-2">Yes</label>
                                            <input id="yes"  class="ml-10" value="0" type="radio" wire:model.live='q39aAnswer' name="answer39a" style="pointer-events: none">
                                            <label for="yes" class="ml-2">No</label>
                                        </div>
                                        <div class="w-full block items-center text-gray-800 dark:text-gray-100 text-xs mt-2">
                            ...
                            <div class="flex flex-col w-full border-2 border-gray-200 dark:border-slate-600 bg-gray-100 dark:bg-slate-700">
                                ...
                                <div class="w-full block sm:flex">
                                    ...
                                    <div class="w-full sm:w-2/6 flex flex-col justify-end p-2 items-start px-4 bg-white dark:bg-slate-700 relative">
                                        <div class="flex items-center">
                                            <input id="yes" type="radio" value="1" wire:model='q40aAnswer' name="answer40a" style="pointer-events: none">
                                            <label for="yes" class="ml-2">Yes</label>
                                            <input id="yes"  class="ml-10" value="0" type="radio" wire:model='q40aAnswer' name="answer40a" style="pointer-events: none">
                                            <label for="yes" class="ml-2">No</label>
                                        </div>
                                        <div class="w-full block items-center text-gray-800 dark:text-gray-100 text-xs mt-2">
                                ...
                                <div class="w-full block sm:flex">
                                    ...
                                    <div class="w-full sm:w-2/6 flex flex-col justify-end p-2 items-start px-4 bg-white dark:bg-slate-700 relative">
                                        <div class="flex items-center">
                                            <input id="yes" type="radio" value="1" wire:model.live='q40bAnswer' name="answer40b" style="pointer-events: none">
                                            <label for="yes" class="ml-2">Yes</label>
                                            <input id="yes"  class="ml-10" value="0" type="radio" wire:model.live='q40bAnswer' name="answer40b" style="pointer-events: none">
                                            <label for="yes" class="ml-2">No</label>
                                        </div>
                                        <div class="w-full block items-center text-gray-800 dark:text-gray-100 text-xs mt-2">
                                ...
                                <div class="w-full block sm:flex">
                                    ...
                                    <div class="w-full sm:w-2/6 flex flex-col justify-end p-2 items-start px-4 bg-white dark:bg-slate-700 relative">
                                        <div class="flex items-center">
                                            <input id="yes" type="radio" value="1" wire:model.live='q40cAnswer' name="answer40c" style="pointer-events: none">
                                            <label for="yes" class="ml-2">Yes</label>
                                            <input id="yes"  class="ml-10" value="0" type="radio" wire:model.live='q40cAnswer' name="answer40c" style="pointer-events: none">
                                            <label for="yes" class="ml-2">No</label>
                                        </div>
                                        <div class="w-full block items-center text-gray-800 dark:text-gray-100 text-xs mt-2">
                                            <p class="text-gray-400">If YES, please specify ID No:</p>
                                                ...
                                                <ul class="space-y-2 text-sm">
                                                    @foreach ($provinces as $province)
                                                        <li class="flex items-center">
                                                            <input
                                                                id="province-{{ $province->province_description }}"
                                                                type="radio" wire:model.live="selectedProvince"
                                                            ...
                                                            <label
                                                                for="province-{{ $province->province_description }}"
                                                                class="ml-2 text-gray-900 dark:text-gray-300">{{ $province->province_description }}</label>
                                                        </li>
                                                    @endforeach
                                                    <li class="flex items-center">
                                                        <input id="any-province" type="radio"
                                                            wire:model.live="selectedProvince" value=""
                                                            class="h-4 w-4 text-neutral-800 dark:text-neutral-200 border-gray-300 dark:border-neutral-500 focus:ring-neutral-900 focus:ring-offset-2 focus:ring-2 focus:outline-none">
                                                ...
                                                <ul class="space-y-2 text-sm">
                                                    @if ($cities)
                                                        @foreach ($cities as $city)
                                                            <li class="flex items-center">
                                                                <input
                                                                    id="city-{{ $city->city_municipality_description }}"
                                                                    type="radio" wire:model.live="selectedCity"
                                                                    value="{{ $city->city_municipality_description }}"
                                                                    class="h-4 w-4 text-neutral-800 dark:text-neutral-200 border-gray-300 dark:border-neutral-500 focus:ring-neutral-900 focus:ring-offset-2 focus:ring-2 focus:outline-none">
                                                                <label
                                                                    for="city-{{ $city->city_municipality_description }}"
                                                                    class="ml-2 text-gray-900 dark:text-gray-300">{{ $city->city_municipality_description }}</label>
                                                            </li>
                                                        @endforeach
                                                    @endif
                                                    <li class="flex items-center">
                                                        <input id="any-city" type="radio"
                                                            wire:model.live="selectedCity" value=""
                                                            class="h-4 w-4 text-neutral-800 dark:text-neutral-200 border-gray-300 dark:border-neutral-500 focus:ring-neutral-900 focus:ring-offset-2 focus:ring-2 focus:outline-none">
                                                        <label for="any-city"
                                                            class="ml-2 text-gray-900 dark:text-gray-300">Any</label>
                                                    </li>
                                                ...
                                                <ul class="space-y-2 text-sm">
                                                    @if ($barangays)
                                                        @foreach ($barangays as $barangay)
                                                            <li class="flex items-center">
                                                                <input
                                                                    id="barangay-{{ $barangay->barangay_description }}"
                                                                    type="radio" wire:model.live="selectedBarangay"
                                                                    value="{{ $barangay->barangay_description }}"
                                                                    class="h-4 w-4 text-neutral-800 dark:text-neutral-200 border-gray-300 dark:border-neutral-500 focus:ring-neutral-900 focus:ring-offset-2 focus:ring-2 focus:outline-none">
                                                                <label
                                                                    for="barangay-{{ $barangay->barangay_description }}"
                                                                    class="ml-2 text-gray-900 dark:text-gray-300">{{ $barangay->barangay_description }}</label>
                                                            </li>
                                                        @endforeach
                                                    @endif
                                                    <li class="flex items-center">
                                                        <input id="any-barangay" type="radio"
                                                            wire:model.live="selectedBarangay" value=""
                                                            class="h-4 w-4 text-neutral-800 dark:text-neutral-200 border-gray-300 dark:border-neutral-500 focus:ring-neutral-900 focus:ring-offset-2 focus:ring-2 focus:outline-none">
                                                ...
                                                <ul class="space-y-2 text-sm">
                                                    <li class="flex items-center">
                                                        <input id="single" type="radio"
                                                            wire:model.live="civil_status" value="Single"
                                                            class="h-4 w-4 text-neutral-800 dark:text-neutral-200 border-gray-300 dark:border-neutral-500 focus:ring-neutral-900 focus:ring-offset-2 focus:ring-2 focus:outline-none">
                                                        <label for="single"
                                                            class="ml-2 text-gray-900 dark:text-gray-300">Single</label>
                                                    </li>
                                                    <li class="flex items-center">
                                                        <input id="married" type="radio"
                                                            wire:model.live="civil_status" value="Married"
                                                            class="h-4 w-4 text-neutral-800 dark:text-neutral-200 border-gray-300 dark:border-neutral-500 focus:ring-neutral-900 focus:ring-offset-2 focus:ring-2 focus:outline-none">
                                                        <label for="married"
                                                    ...
                                                    <li class="flex items-center">
                                                        <input id="widowed" type="radio"
                                                            wire:model.live="civil_status" value="Widowed"
                                                            class="h-4 w-4 text-neutral-800 dark:text-neutral-200 border-gray-300 dark:border-neutral-500 focus:ring-neutral-900 focus:ring-offset-2 focus:ring-2 focus:outline-none">
                                                        <label for="widowed"
                                                            class="ml-2 text-gray-900 dark:text-gray-300">Widowed</label>
                                                    </li>
                                                    <li class="flex items-center">
                                                        <input id="separated" type="radio"
                                                            wire:model.live="civil_status" value="Separated"
                                                            class="h-4 w-4 text-neutral-800 dark:text-neutral-200 border-gray-300 dark:border-neutral-500 focus:ring-neutral-900 focus:ring-offset-2 focus:ring-2 focus:outline-none">
                                                        <label for="separated"
                                    ...
                                    <ul class="space-y-2 text-sm">
                                        ...
                                        <li class="flex items-center">
                                            <input id="citizenship" type="checkbox"
                                                wire:model.live="filters.citizenship" class="h-4 w-4">
                                        ...
                                        <li class="flex items-center">
                                            ...
                                            <label for="civil_status"
                                                class="ml-2 text-gray-900 dark:text-gray-300">Civil
                                                Status</label>
                                        </li>
                                        <li class="flex items-center">
                                        ...
                                        <li class="flex items-center">
                                            <input id="blood_type" type="checkbox"
                                                wire:model.live="filters.blood_type" class="h-4 w-4">
                                            <label for="blood_type"
                                                class="ml-2 text-gray-900 dark:text-gray-300">Blood
                                                Type</label>
                                        </li>
                                        <li class="flex items-center">
                                        ...
                                        <li class="flex items-center">
                                            <input id="pagibig" type="checkbox" wire:model.live="filters.pagibig"
                                                class="h-4 w-4">
                                            <label for="pagibig"
                                                class="ml-2 text-gray-900 dark:text-gray-300">PAGIBIG ID
                                                No.</label>
                                        </li>
                                        <li class="flex items-center">
                                            <input id="philhealth" type="checkbox"
                                                wire:model.live="filters.philhealth" class="h-4 w-4">
                                        ...
                                        <li class="flex items-center">
                                            <input id="residential_selectedProvince" type="checkbox"
                                                wire:model.live="filters.residential_selectedProvince"
                                                class="h-4 w-4">
                                        ...
                                        <li class="flex items-center">
                                            <input id="residential_selectedBarangay" type="checkbox"
                                                wire:model.live="filters.residential_selectedBarangay"
                                                class="h-4 w-4">
