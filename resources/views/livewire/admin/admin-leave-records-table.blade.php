                            ...
                            <table class="w-full min-w-full">
                                ...
                                <thead class="bg-gray-200 dark:bg-gray-700 rounded-xl">
                                    <tr class="whitespace-nowrap">
                                        <th class="px-5 py-3 text-sm font-medium text-left uppercase text-center">Name
                                        </th>
                                        <th class="px-5 py-3 text-sm font-medium text-left uppercase text-center">Date
                                            of Filing</th>
                                        <th class="px-5 py-3 text-sm font-medium text-left uppercase text-center">Type
                                            of Leave</th>
                                        <th class="px-5 py-3 text-sm font-medium text-left uppercase text-center">
                                            Details of Leave</th>
                                        <th class="px-5 py-3 text-sm font-medium text-left uppercase text-center">Number
                                            of Days</th>
                                        <th class="px-5 py-3 text-sm font-medium text-left uppercase text-center">Start
                                            Date</th>
                                        <th class="px-5 py-3 text-sm font-medium text-left uppercase text-center">End
                                            Date</th>
                                        <th class="px-5 py-3 text-sm font-medium text-left uppercase text-center">Status
                                        </th>
                                    </tr>
                                </thead>
                                <!-- Table body -->
