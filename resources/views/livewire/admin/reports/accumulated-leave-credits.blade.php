    ...
    <div class="p-4">
        <div class="grid grid-cols-12 gap-4">
            ...
            <div class="col-span-full sm:col-span-6 bg-blue-100 dark:bg-blue-800 p-4 rounded-lg shadow">
                <div class="text-sm font-semibold text-blue-800 dark:text-gray-100 mb-4">
                    Leave Credits
                    <hr class="border-t border-blue-200 dark:border-blue-600">
                    <div class="flex items-center justify-between">
                        <div>
                            <label class="text-xs text-gray-900 dark:text-gray-300">Select Leave
                                Type:</label>
                            <ul class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4 text-xs mt-2">
                                <li class="flex items-center">
                                    <input type="checkbox" wire:model="selectedLeaveTypes" value="Vacation Leave"
                                        class="h-4 w-4">
                                    <label class="sm:ml-2 text-gray-900 dark:text-gray-300">Vacation Leave</label>
                                </li>
                                <li class="flex items-center">
                                    <input type="checkbox" wire:model="selectedLeaveTypes" value="Sick Leave"
                                        class="h-4 w-4">
                                    <label class="sm:ml-2 text-gray-900 dark:text-gray-300">Sick Leave</label>
                                </li>
                                <li class="flex items-center">
                                    <input type="checkbox" wire:model="selectedLeaveTypes"
                                        value="Special Privilege Leave" class="h-4 w-4">
                                    <label class="sm:ml-2 text-gray-900 dark:text-gray-300">Special Privilege
                                        Leave</label>
                                </li>
                            </ul>
                        </div>
