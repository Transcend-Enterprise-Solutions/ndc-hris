    ...
    <div style="padding: 0 3rem 3rem 3rem">
        ...
        <table style="width: 100%;">
            <tbody>
                <tr>
                    <td width="30">
                        <img src="images/ndc_logo.png" alt="" width="70" style="margin-left: 20px">
                    </td>
                    <td width="40">
                        <p style="text-align: center; font-size: 14px; font-weight: bold; margin-top: 10px;">
                            NATIONAL DEVELOPMENT COMPANY <br>
                            OFFICIAL BUSINESS (OB) SLIP
                        </p>
                    </td>
                    <td width="30">
                        <img src="images/ndc_logo.png" alt="" width="80" style="opacity: 0">
                    </td>
                </tr>
            </tbody>
        </table>
