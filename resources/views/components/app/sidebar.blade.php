<div>
    ...
    <div id="sidebar"
        ...
        <div class="space-y-8 ">
            ...
            <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(1), ['finance'])){{ 'bg-slate-700' }}@endif"
                ...
                <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                    <ul class="pl-9 mt-1 @if(!in_array(Request::segment(1), ['finance'])){{ 'hidden' }}@endif"
                        ...
                        <li class="mb-1 last:mb-0">
                            <a class="block text-black dark:text-slate-400 hover:text-blue-500 transition duration-150 truncate @if(Route::is('transactions')){{ '!text-blue-500' }}@endif"
                                href="#0">
                                <span
                                    class="text-sm font-medium @if(Route::is('transactions')){{ 'text-blue-500' }}@endif">Leave</span>
                            </a>
                        </li>
                        <li class="mb-1 last:mb-0">
            ...
            <!-- Payroll Management -->
            <li
                class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(1), ['payroll'])){{ 'bg-slate-700' }}@endif">
