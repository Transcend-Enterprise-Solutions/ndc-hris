...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::get('/wfh-attendance', function () {
        return view('livewire.user.wfh-attendance'); })->name('wfh-attendance');
    ...
    Route::get('/my-schedule', function () {
        return view('livewire.user.my-schedule'); })->name('my-schedule');
    ...
    Route::get('/emp-documents', function () {
        return view('livewire.admin.emp-documents'); })->name('emp-documents');
